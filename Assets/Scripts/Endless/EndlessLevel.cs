...
public class EndlessLevel : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.position = Vector3.Lerp(new Vector3(transform.position.x, -10f, transform.position.z), new Vector3(transform.position.x, 8f, transform.position.z), lerpPercentage);
    }
}
